...
class Face_Recognition:
    ...
    def __init__(self,root):
        ...
        # first header image  
        img=Image.open(r"C:\Users\Admin\Python_Test_Projects\Images_GUI\banner.jpg")
    ...
    def face_recog(self):
        def draw_boundray(img,classifier,scaleFactor,minNeighbors,color,text,clf):
            ...
            for (x,y,w,h) in featuers:
                ...
                conn = mysql.connector.connect(username='root', password='22022000',host='localhost',database='face_recognition',port=3306)
                cursor = conn.cursor()
